...
else if($FormularioActivo == "SubirArchivos")
    $MenuSubirArchivosActivo = "active";
else if($FormularioActivo == "ConsultaArchivosSubidos")
    $MenuConsultaArchivosSubidosActivo = "active";    
...
<?php } // if ($UsuarioSesionEsAdmin) ?>      
      <li class="nav-item <?php echo $MenuSubirArchivosActivo ?>">
        <a class="nav-link" href="subirArchivos.php" target="_top">Subir Archivos</a>
      </li>
<?php if ($UsuarioSesionEsAdmin) { ?>
      <li class="nav-item <?php echo $MenuConsultaArchivosSubidosActivo ?>">
        <a class="nav-link" href="consultaArchivosSubidos.php" target="_top">Consulta de Archivos Subidos</a>
      </li>
<?php } // if ($UsuarioSesionEsAdmin) ?>      
<?php if ($UsuarioSesionEsAdmin) { ?>
